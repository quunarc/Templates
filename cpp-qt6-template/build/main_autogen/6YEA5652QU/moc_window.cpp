...
template <> constexpr inline auto Tester::qt_create_metaobjectdata<qt_meta_tag_ZN6TesterE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'sigLabelTextUpdated'
        QtMocHelpers::SignalData<void(std::string_view)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 2 },
        }}),
    };
...
void Tester::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->sigLabelTextUpdated((*reinterpret_cast<std::add_pointer_t<std::string_view>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Tester::*)(std::string_view )>(_a, &Tester::sigLabelTextUpdated, 0))
            return;
    }
}
...
// SIGNAL 0
void Tester::sigLabelTextUpdated(std::string_view _t1)
{
